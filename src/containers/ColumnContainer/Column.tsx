...
const BooksColumn: FC<BooksColumnProps> = ({ books, columnName }) => {
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="w-full grid grid-cols-3 gap-1 align-middle justify-center items-center lg:flex lg:gap-3 lg:justify-start lg:flex-wrap">
        {books.map((book) => (
